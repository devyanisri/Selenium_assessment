...
public class Asess {
	...
	public static void main(String[]args) throws Exception{
		xlRead("C:\\Users\\dsrivastav23\\Documents\\YahooDDF.xls");
		...
		vSearch=xData[i][0];
		myD.findElement(By.xpath("/html/body/div[2]/div/div/div/div/div/div/div[2]/div/div/form/table/tbody/tr/td[1]/input[1]"))
		.sendKeys(vSearch,Keys.ENTER);
		Thread.sleep(2000);
		xData[i][2]=myD.getTitle();
		myD.close();
			}
			}
		xlwrite("C:\\Users\\dsrivastav23\\Documents\\YahooDDF2.xls",xData);
}
